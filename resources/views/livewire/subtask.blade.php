<div>
    ...
    @foreach($subtask as $item)
      <div class="row mb-2" wire:key="{{ $item }}">
        <div class="col">
          <input name="subtask[]" type="text" class="mb-2 form-control" placeholder="{{'Subtask '.($item+1)}}"/>
        </div>
        <div class="col-auto">
          <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-file-minus-fill ml-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg" wire:click="remove({{ $item }})">
